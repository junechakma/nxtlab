...
import { FOCUS_AREAS, PROJECTS, PUBLICATIONS, MENTORS, EVENTS, STATS, UNIVERSITY_NAME, COLLABORATORS, EXTRA_STATS } from './constants';
import { ArrowRight, MapPin, Download, Trophy, Globe, Zap, Mail, Plus, Phone, ExternalLink } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col font-sans bg-white text-slate-900">
      ...
      <section className="bg-slate-900 text-white py-20 border-y border-white/10 overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          {/* Extra Stats Row - Styled identically to top row */}
      ...
      <section id="projects" className="py-16 md:py-32 bg-slate-50 overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          <Reveal delay={400} variant="fade" className="mt-16 text-center">
            <a href="#" className="inline-flex items-center gap-2 text-lg font-bold border-b-2 border-brand-600 pb-1 hover:text-brand-600 transition-colors">
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-1/3">
              <Reveal variant="fade">
                ...
                <a href="#" className="text-brand-600 font-bold hover:underline">Browse Archive &rarr;</a>
              </Reveal>
            </div>
            ...
            <div>
              <Reveal delay={200} variant="fade">
                ...
                <ul className="space-y-4 text-slate-400 text-sm">
                  <li><a href="#focus" className="hover:text-white transition-colors">Research Areas</a></li>
                  <li><a href="#projects" className="hover:text-white transition-colors">Projects</a></li>
                  <li><a href="#publications" className="hover:text-white transition-colors">Publications</a></li>
                  <li><a href="#mentors" className="hover:text-white transition-colors">People</a></li>
                </ul>
              </Reveal>
            </div>
              ...
              <Reveal delay={300} variant="fade">
                ...
                <ul className="space-y-4 text-slate-400 text-sm">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <a href="mailto:info@uftb.ac.bd" className="hover:text-white">info@uftb.ac.bd</a>
                  </li>
                  <li className="flex items-center gap-3">
